	...
	return (
		...
		>
			<div
				...
				className="h-96 bg-slate-950/70 backdrop-blur rounded-lg w-full max-w-3xl mx-auto shadow-xl cursor-text font-mono overflow-y-auto"
			>
				<TerminalHeader />
...
const InitialText = () => {
	return (
		<>
			<p>Hello, I am excited to connect!</p>
...
const QUESTIONS = [
	{
		key: "email",
		text: "To start, can you please provide ",
		postfix: "your email?",
		complete: false,
		value: "",
	},
	...
	},
	{
		key: "description",
		text: "Perfect, and ",
		postfix: "what would you like to say?",
		complete: false,
		value: "",
	},
];
